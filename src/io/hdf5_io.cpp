                                  ...
                                  Real time, Real value) const
{
    ...
    hid_t dataset;
    if (H5Lexists(file, dataset_name.c_str(), H5P_DEFAULT) > 0) {
...
{
#ifdef GRANITE_USE_HDF5
    // TODO: Write Ψ₄ spherical harmonic decomposition data
#endif
}
...
#ifdef GRANITE_USE_HDF5
    // TODO: Iterate over HDF5 file and collect dataset names
#endif
    return names;
}
