...
> 
> When I started this project, I wasn't looking to fork an existing engine. I wanted to test a radical idea: *Could a single person, armed with modern tools, architect a full numerical relativity engine from scratch in just a week?* The answer depends on how you define 'build.' 
> 
> I will be radically transparent: **80% to 90% of the raw code lines were generated by advanced AI models**, which I directed, orchestrated, and fed with precise prompts. But the remaining 10% to 20%—the architectural blueprint, the physical decisions (which CCZ4 terms to use, how to handle punctures, which Riemann solver schemas to apply), hunting down deep mathematical bugs (like $C^0$ prolongation discontinuities, HLLD sign errors, and CT in-place mutations), and running hundreds of tests—**that was entirely on me.**
> 
> I worked 14 to 18 hours a day for 8 days straight, spending hundreds of dollars on compute credits, pulling energy I didn't know I had. The result is **GRANITE**: imperfect, but capable of passing 92 rigorous tests, running BBH simulations, and producing institutional-grade telemetry. 
> 
> *I am not ashamed to say AI was my core partner; I am proud to have led it.* In this new era, a true engineer isn't the one who types the fastest, but the one who knows how to ask the right questions, understand the math, and quickly fix what the machine misses.
> 
> ---
> 
> #### ⚠️ Deployment Notice
